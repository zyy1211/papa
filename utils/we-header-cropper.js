    ...
    return w.prototype.init = function() {
        ...
        void 0 === c && (c = o), t.outsideBound = function(e, o) {
            ...
            void 0 === s && (s = 1), [ {
                ...
                t.ctx.beginPath(), t.ctx.setStrokeStyle(u), t.ctx.setLineWidth(2), t.ctx.moveTo(e.start.x, e.start.y), 
            ...
            t.ctx.fill(), t.ctx.beginPath(), t.ctx.setStrokeStyle(u), t.ctx.setLineWidth(1), 
            t.ctx.rect(r - s + 1, a - s + 1, i + 2 * s - 2, c + 2 * s - 2), t.ctx.stroke();
        };
