...
var e = function() {
    ...
    buildWxRequestConfig: function(t, e) {
        ...
        return e.header = {
            ...
            e.statusCode = o.WX_ERR_CODE, t.fail(i.buildErrorConfig(o.WX_ERR_CODE, e.errMsg));
            ...
            switch (+e.statusCode) {
              ...
              case o.WX_OK_CODE:
                var a = e.data;
                0 === a.status ? t.complete(a) : t.complete(i.buildErrorConfig(a.status, a.message));
                break;
    ...
    locationProcess: function(t, e, a, r) {
        var n = this;
        a = a || function(e) {
        ...
        }, t.location ? n.checkLocation(t) && e(i.getLocationParam(t.location)) : n.getWXLocation(e, a, r);
    }
}, a = function() {
    function o(e) {
    ...
    return e(o, [ {
        ...
        value: function(t) {
            ...
            if (t = t || {}, i.polyfillParam(t), i.checkKeyword(t)) {
                ...
                var a = t.distance || "1000", r = t.auto_extend || 1;
                i.locationProcess(t, function(e) {
                    o.boundary = "nearby(" + e.latitude + "," + e.longitude + "," + a + "," + r + ")", 
